...
class Dataset(object):
    ...
    def read_arrow(
        ...
        :param bool sample_batching: Should query merge and batch samples? This is a performance optimization for large queries.
        ...
        self.reader.set_sample_batching(sample_batching)
