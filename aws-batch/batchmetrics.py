        ...
        for attempt in attempts:
            ...
            if instance not in usage_interval_per_instance:
                ...
                usage_interval_per_instance[instance] = (
                    min(curr[0], started_at), max(curr[1], stopped_at))
...
def print_stats_report(stats, instance_price_per_hr=1.00):
    ...
    print('- {} / {} jobs succeeded'.format(stats['num_succeeded'],
                                            stats['num_jobs']))
    print('- {} jobs had more than 1 attempt.'.format(stats['num_retried']))
    print(
        '- {} instances used.'.format(stats['num_instances']))
    print(
    ...
    # compute used.
    print('- Total cost estimate ${:.2f} ({:.2f} hours @ ${:.4f} / hr)'.format(
